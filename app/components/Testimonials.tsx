      ...
      <div className="px-5 sm:px-20 py-20 w-full bg-[#111111]">
        <div className="flex flex-col justify-center items-center">
          <div className="text-center">
            <h1 className="text-[35px] text-white font-extrabold">Testimonials</h1>
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 select-none">
            ...
            <div className="flex flex-col justify-stretch w-full bg-gray-300 px-10 py-5 rounded-md">
              <p className="text-md sm:text-lg text-gray-900 text-opacity-65 font-mono">
              ...
              <div className="mt-auto">
                <h1 className="mt-5 text-[17px] sm:text-[19px] text-opacity-65 text-gray-900 font-bold">Nelson Bathan</h1>
                <h2 className="text-[13px] sm:text-[17px] text-opacity-65 text-gray-900 font-bold">Senior Lead Software Engineer, Peddlr</h2>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-stretch w-full bg-gray-300 px-10 py-5 rounded-md">
              ...
              <div className="mt-auto">
                <h1 className="mt-5 text-[17px] sm:text-[19px] text-opacity-65 text-gray-900 font-bold">Dhave Barsalote</h1>
                <h2 className="text-[13px] sm:text-[17px] text-opacity-65 text-gray-900 font-bold">Former Senior Software Engineer, Peddlr</h2>
              </div>
            </div>

            <div className="flex flex-col justify-stretch w-full bg-gray-300 px-10 py-5 rounded-md">
              <p className="text-md sm:text-lg text-gray-900 text-opacity-65 font-mono">
                &quot;My time workng with Emmanuel was truly incredible. Out collaboration in achieving the goals for the task was impressive, and he was always very responsive to my concerns. He has a great ability to adapt to technical challenges. thanks to his flexibility. I look forward to the opportunity to work with him again in the future!&quot;
              </p>
              <div className="mt-auto">
                <h1 className="mt-5 text-[17px] sm:text-[19px] text-opacity-65 text-gray-900 font-bold">Eubie Jay Clemente</h1>
                <h2 className="text-[13px] sm:text-[17px] text-opacity-65 text-gray-900 font-bold">Former Full Stack Developer, Peddlr</h2>
              </div>
            </div>
